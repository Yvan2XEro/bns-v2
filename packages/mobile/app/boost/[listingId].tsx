...
export default function BoostModal() {
	...
	const listingWebUrl =
		webUrl && listingId
			? `${webUrl.replace(/\/$/, "")}/listing/${listingId}`
			: null;
	...
	const handleOpenInBrowser = async () => {
		...
		await openBrowserAsync(listingWebUrl, {
		...
		>
			...
			<View style={styles.container}>
				...
				>
					...
					<Text style={[styles.unavailableHint, { color: mutedColor }]}>
						{t("boost.mobileUnavailableBrowserHint")}
					</Text>
					{listingId ? (
				...
				{listingWebUrl ? (
					...
					>
						...
						<Text style={[styles.browserActionText, { color: primaryColor }]}>
							{t("boost.openListingInBrowser")}
						</Text>
					</Pressable>
				) : null}
