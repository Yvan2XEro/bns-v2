...
import { Minus, Plus, RotateCcw, Check, X } from "lucide-react";
	...
	return createPortal(
		<div className="fixed inset-0 z-[9999] bg-black">
			...
			<div className="pointer-events-none absolute inset-x-0 top-0 z-10 flex items-center justify-between px-4 py-3">
				<button
					onClick={onCancel}
					className="pointer-events-auto flex items-center gap-1.5 rounded-lg bg-black/50 px-3 py-1.5 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-black/70"
				>
					<X className="h-4 w-4" />
					Cancel
				</button>
				<button
					...
					className="pointer-events-auto flex items-center gap-1.5 rounded-lg bg-[#1E40AF] px-4 py-1.5 text-sm font-bold text-white transition-all hover:bg-[#2563EB] active:scale-95"
				>
