		...
		<div className="min-h-screen bg-[#F8FAFC]">
			<section className="relative overflow-hidden bg-[#1E40AF] py-12">
				...
				<div className="container relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
					...
					<h1 className="font-extrabold text-3xl text-white">Privacy Policy</h1>
					...
					<div className="prose prose-sm max-w-none text-[#475569] [&_h2]:mt-8 [&_h2]:mb-3 [&_h2]:font-bold [&_h2]:text-[#0F172A] [&_h2]:text-lg [&_h3]:mt-6 [&_h3]:mb-2 [&_h3]:font-semibold [&_h3]:text-[#0F172A] [&_li]:mb-1 [&_p]:mb-3 [&_p]:leading-relaxed [&_ul]:mb-3 [&_ul]:list-disc [&_ul]:pl-5">
						...
						<ul>
							<li>
								...
								password, phone number, location, and profile photo.
							</li>
							<li>
								<strong>Listing data:</strong> Photos, descriptions, prices, and
								other details you add to listings.
							</li>
							<li>
								<strong>Messages:</strong> Content of messages sent through our
								platform.
							</li>
							<li>
								<strong>Reviews:</strong> Ratings and comments you leave for
								other users.
							</li>
						</ul>
						...
						<ul>
							<li>
								<strong>Other users:</strong> Your public profile (name, avatar,
								location, rating) is visible to other users. Your email and
								phone are never shared publicly.
							</li>
							<li>
								<strong>Payment providers:</strong> NotchPay receives necessary
								transaction data to process boost payments.
							</li>
							<li>
						...
						<p>
							...
							data, including encrypted connections (HTTPS), secure password
							hashing, and access controls. However, no system is 100% secure,
						...
						<ul>
							...
							<li>
								<strong>Update</strong> your information at any time through the
								Settings page
							</li>
							<li>
								<strong>Delete</strong> your account and associated data through
						...
						<p>
							...
							days. Some data may be retained longer if required by law or for
							legitimate business purposes (fraud prevention, legal disputes).
						</p>

						<h2>7. Children&apos;s Privacy</h2>
						<p>
							Buy&apos;N&apos;Sellem is not intended for use by anyone under the
						...
						<p>
							...
							these external services. We encourage you to read their privacy
							policies.
						</p>
						...
						<p>
							...
							the platform. Your continued use of the Service after changes
