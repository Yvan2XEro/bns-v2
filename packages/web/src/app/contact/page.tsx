						...
						<div className="space-y-3 pt-2">
							{contactInfo.map((info) => (
								<div key={info.label} className="flex items-start gap-3">
									...
									<div>
										<p className="text-xs font-medium text-[#94A3B8]">{info.label}</p>
										{info.href ? (
											<a
												href={info.href}
												className="text-sm font-medium text-[#0F172A] hover:text-[#1E40AF]"
											>
												{info.value}
											</a>
										) : (
									...
									<div className="space-y-2">
										...
										>
											...
											<SelectContent>
												...
												<SelectItem value="report">Report a user/scam</SelectItem>
