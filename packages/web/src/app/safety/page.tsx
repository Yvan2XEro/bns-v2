		...
		<div className="min-h-screen bg-[#F8FAFC]">
			...
			<section className="relative overflow-hidden bg-[#1E40AF] py-12">
				...
				<div className="container relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
					...
					<h1 className="text-3xl font-extrabold text-white">Safety Tips</h1>
			...
			<div className="container mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
				...
				<div className="grid gap-4 sm:grid-cols-2">
					{tips.map((tip) => (
						...
						>
							<div className={`mb-3 flex h-10 w-10 items-center justify-center rounded-lg ${tip.color}`}>
				...
				<div className="mt-10 rounded-xl border border-emerald-200 bg-emerald-50 p-6">
					...
					<ul className="mt-4 space-y-2 text-sm text-emerald-700">
						...
						<li>3. Report the user or listing using the &ldquo;Report&rdquo; button</li>
